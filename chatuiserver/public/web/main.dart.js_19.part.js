...
aQT(){return new C.nI(null)},
nI:function nI(d){this.a=d},
SA:function SA(d){this.d=d
this.c=this.a=null},
amT:function amT(d){this.a=d},
amU:function amU(){},
amV:function amV(d){this.a=d},
amW:function amW(d){this.a=d}},D,F
A=c[0]
B=c[2]
E=c[18]
...
F=c[20]
C.nI.prototype={
a9(){return new C.SA(A.wK(null,null))}}
C.SA.prototype={
xm(d,e){var x=null,w=e?32:24
...
return new A.bo(new A.a1(0,0,0,w),A.ck(v,B.p,B.aD,B.o),x)},
J(d){return D.lm(B.w,new D.k0(new C.amW(this),null),!0)},
m(){this.d.m()
this.aC()}}
var z=a.updateTypes(["pe(M,ac)"])
C.amT.prototype={
$0(){var x=this.a.c
x.toString
return A.dg(x,!1).jS("/",null,y.a)},
$S:0}
C.amU.prototype={
$0(){$.kJ().sl(0,!0)},
$S:0}
...
t=n?48:32
s=A.bd(n?24:16)
r=A.ak(51,B.h.gl(0)>>>16&255,B.h.gl(0)>>>8&255,B.h.gl(0)&255)
q=n?20:15
r=A.a([new A.cW(0,B.bx,r,new A.k(0,n?12:8),q)],y.c)
q=y.e
t=A.by(A.a([u,A.au(A.jZ("assets/like.png",p,p,B.fn,n?500:p,1/0),B.C,p,p,new A.b5(p,p,p,s,r,p,B.z),p,p,new A.a1(0,t,0,t),p,1/0),m.xm("Our Story",n),m.xl('On May 22nd, 2023, Payoor was born out of a simple but powerful truth, grocery shopping can be stressful, and one of our founders "does not like stress". After one too many exhausting market runs, the thought became clear: There has to be a faster, easier way to get fresh groceries for home-cooked meals.',n),m.xl("That single frustration sparked a journey that took over a year of research, development, and fine-tuning to create Payoor; a smart, seamless grocery shopping experience designed for people who value their time but still want quality, fresh ingredients.",n),m.xm("Our Mission",n),m.xl("To make grocery shopping fast, effortless, and stress-free by providing a smart, clean, and convenient way to get fresh food straight to your kitchen. We believe that every meal shouldn't a stressful and tragic backstory.",n),m.xm("Our Vision",n),m.xl("To redefine how people shop for groceries by making convenience, freshness, and simplicity the new standard one home-cooked meal at a time.",n)],q),B.a5,p,B.t,B.o)
return E.tC(A.au(new A.fa(new A.ac(0,h,i.a.b,1/0),A.au(A.by(A.a([x,w,new A.bo(new A.a1(v,0,v,0),t,p),A.bi(p,n?48:32,p)],q),B.a5,p,B.t,B.o),B.l,B.w,p,p,p,p,p,p,j.a.a),p),B.l,p,p,p,p,p,p,new A.a1(l,k,l,k),o),m.d,B.a4)},
$S:z+0};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(C.nI,A.T)
x(C.SA,A.a0)
w(A.fu,[C.amT,C.amU,C.amV])
x(C.amW,A.fU)})()

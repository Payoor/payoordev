    ...
    <div>
      <form id="paymentForm">
        <div class="form-group">
          ...
          <input type="text" id="last-name" :value="userData.name ? userData.name + userData.name : ''" />
        </div>
      </form>
    </div>
  </template>
    ...
    methods: {
      ...
      initializeBani() {
        ...
        let handler = BaniPopUp({
          ...
          lastName: document.getElementById('last-name')?.value || (this.userData.name + this.userData.name),

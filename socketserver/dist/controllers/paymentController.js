...
var PaymentController = /*#__PURE__*/function () {
  ...
  return _createClass(PaymentController, [{
    key: "createOrder",
    value: function () {
      var _createOrder = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId) {
    ...
    value: function () {
      var _generatePaymentLink = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var userId, isValid, order, https, errorResponse;
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 14:
              ...
              errorResponse = {
                success: false,
                data: {
                  message: _context2.t0.message || 'Failed to generate payment link',
      ...
      function generatePaymentLink(_x2, _x3) {
    ...
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 6:
              ...
              _context3.t0 = event.event;
              _context3.next = _context3.t0 === 'charge.success' ? 12 : _context3.t0 === 'transfer.success' ? 14 : _context3.t0 === 'charge.failed' ? 16 : 17;
              break;
            case 12:
            ...
            case 21:
              ...
              console.error('Webhook processing error:', _context3.t1);
              errorResponse = {
                success: false,
                data: {
                  message: _context3.t1.message || 'Error handling payment response',
                  error: process.env.NODE_ENV === 'development' ? _context3.t1.toString() : undefined,
                  timestamp: new Date().toISOString()
                }
              };
      ...
      function handlePayStackPaymentResponse(_x4, _x5) {

          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              errorResponse = {
                success: false,
                data: {
                  message: _context.t0.message || 'Failed to generate payment link',
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              _context2.next = _context2.t0 === 'charge.success' ? 11 : _context2.t0 === 'transfer.success' ? 13 : _context2.t0 === 'charge.failed' ? 15 : 16;
              break;
            case 11:
            ...
            case 20:
              ...
              console.error('Webhook processing error:', _context2.t1);
              errorResponse = {
                success: false,
                data: {
                  message: _context2.t1.message || 'Error handling payment response',
                  error: process.env.NODE_ENV === 'development' ? _context2.t1.toString() : undefined,
                  timestamp: new Date().toISOString()
                }
              };
              return _context2.abrupt("return", res.status(500).json(errorResponse));
            case 25:
            case "end":
          ...
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 13:
              ...
              errorResponse = {
                success: false,
                data: {
                  message: _context3.t0.message || 'Failed to verify payment',

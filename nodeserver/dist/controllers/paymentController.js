  ...
  return _createClass(PaymentController, [{
    ...
    value: function () {
      var _handleBaniPayment = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
        var merchant_private_key, headers, body, sig, hmac, digest, webhookData, orderRef, paymentStatus;
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 9:
              sig = Buffer.from(headers["bani-hook-signature"], "utf8"); // Calculate HMAC
              hmac = crypto.createHmac("sha256", merchant_private_key);
              digest = Buffer.from(hmac.update(body).digest("hex"), "utf8"); // Verify signature
            ...
            case 14:
              ...
              orderRef = webhookData.data.custom_data.order_ref;
              ...
              _context8.next = 21;
              return _order["default"].findByIdAndUpdate(orderRef, {
                reference: webhookData.data.transaction_ref,
                status: 'processing'
              });
            case 21:
              (0, _getOrderDetails["default"])(orderRef);
            case 22:

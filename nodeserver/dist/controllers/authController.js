      ...
      var _handleSignUp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, phone = _req$body2.phone, location = _req$body2.location, shoppingList = _req$body2.shoppingList;
              _context3.next = 4;
              return _user["default"].findOne({
                email: email
              });
            case 4:
              ...
              return _context3.abrupt("return", res.status(400).json(duplicateResponse));
            case 10:

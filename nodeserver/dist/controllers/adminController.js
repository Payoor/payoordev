  ...
  return _createClass(AdminController, [{
    ...
    value: function () {
      var _uploadExcelSheet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var schematype, excelSheetData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              schematype = req.query.schematype;
              if (req.file) {
                _context.next = 4;
                break;
              }
            ...
            case 4:
              ...
              _context.next = 8;
              return processExcelSheetData(excelSheetData);
            case 8:
              res.status(201).send({
...
function processExcelSheetData(_x5) {
  return _processExcelSheetData.apply(this, arguments);
}
function _processExcelSheetData() {
  _processExcelSheetData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(excelSheetData) {
    var index, productData;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.t0 = _regeneratorRuntime().keys(excelSheetData);
        case 1:

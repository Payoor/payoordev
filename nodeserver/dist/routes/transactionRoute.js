...
transactionRoute.get('/user/get/transactions', _verifyJWT["default"], _transactionController["default"].getUserTransactions);
transactionRoute.get('/user/get/transaction', _verifyJWT["default"], _transactionController["default"].getTransaction);

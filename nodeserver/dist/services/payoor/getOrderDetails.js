...
function _getOrderDetails() {
  _getOrderDetails = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(orderid) {
    var order, _user$completed_order, itemsWithUnits, user_name, user_email, order_address, total, user, user_data_redis_store;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          total = order.total;
          _context.next = 12;
          return _user["default"].findById(order.userId);
        case 12:
          user = _context.sent;
          user_data_redis_store = "userdata:".concat(user._id.toString());
          user.completed_orders = ((_user$completed_order = user.completed_orders) !== null && _user$completed_order !== void 0 ? _user$completed_order : 0) + 1;
          _context.next = 17;
          return user.save();
        case 17:
          _context.next = 19;

...
var _chatWithAdminSocketInit = require("./services/payoor/chatWithAdminSocketInit");
...
var _updateAllVariantCounts = _interopRequireDefault(require("./utils/updateAllVariantCounts"));
...
app.post('/upload', _verifyToken["default"], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, image, filename, authData, fileExtension, uniqueFilename, buffer, filePath, fileUrl;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body = req.body, image = _req$body.image, filename = _req$body.filename;
          authData = req.authData;
          if (!(!image || !filename)) {
            _context2.next = 5;
            break;
          }
          return _context2.abrupt("return", res.status(400).send('Image and filename are required'));
        case 5:
          fileExtension = _path["default"].extname(filename);
          uniqueFilename = "".concat(crypto.randomBytes(16).toString('hex')).concat(fileExtension);
          buffer = Buffer.from(image, 'base64');
          filePath = _path["default"].join(uploadDir, uniqueFilename);
...
function dropIndex(_x4) {
  return _dropIndex.apply(this, arguments);
} // 14. Start server
function _dropIndex() {
  _dropIndex = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(indexName) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _product["default"].collection.dropIndex(indexName);
        case 3:
          console.log("Index ".concat(indexName, " dropped successfully"));
          _context4.next = 9;
          break;
        case 6:
          _context4.prev = 6;
          _context4.t0 = _context4["catch"](0);
          console.error("Error dropping index ".concat(indexName, ":"), _context4.t0);
        case 9:
        case "end":
...
(0, _chatWithAdminSocketInit.initSocket)(server);
...
var updateAllVariantCountsCronJob = _nodeCron["default"].schedule('0 0 * * *', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var result;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        ...
        _context3.next = 3;
        return (0, _updateAllVariantCounts["default"])();
      case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _affiliate["default"].deleteMany({});
        case 3:
          _context5.next = 5;
  ...
  _dropNameIndex = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          collection = _db["default"].connection.collection('affiliates');
          _context6.next = 4;
        ...
        case 4:
          ...
          name_index = indexes.find(function (ind) {
            return ind.name === 'name_1';
          });
          if (!name_index) {
            _context6.next = 9;
            break;

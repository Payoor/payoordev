...
var corsOptions = {
  origin: ['https://admin.development.payoor.store', 'https://admin.payoor.store', 'https://chat.payoor.store', 'https://chat.development.payoor.store'],
...
function _dropIndex() {
  _dropIndex = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(indexName) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          console.error("Error dropping index ".concat(indexName, ":"), _context3.t0);
        case 9:
        case "end":
